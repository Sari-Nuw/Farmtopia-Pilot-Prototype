...
def cluster_sizing(bounding,x_diff,y_diff,poly,image):
    ...
    line_clip(vert_line_left,poly,image)
    ...
    line_clip(vert_line_mid,poly,image)
    ...
    line_clip(vert_line_right,poly,image)
    ...
    line_clip(horz_line_top,poly,image)
    ...
    line_clip(horz_line_mid,poly,image)
    ...
    line_clip(horz_line_bot,poly,image)
